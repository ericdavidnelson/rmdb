const Footer = () => {
    return (
        <footer class=" bg-white dark:bg-gray-800 w-full h-full py-8">
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
                <a href="#" class="text-gray-400 hover:text-gray-800 dark:hover:text-white hover:text-gray-800 transition-colors duration-200">
